...
* Results are written under results/llama4_runs_FAERS by default.
...
/compute001/lwu/projects/LLM4AE/LLM4AE-dev/publication
    ...
    results/llama4_runs_FAERS/

Examples
--------
python scripts/run_FAERS_llama4.py
python scripts/run_FAERS_llama4.py --limit 10
python scripts/run_FAERS_llama4.py --no-resume
python scripts/run_FAERS_llama4.py --timeout 600 --max-output-tokens 32768
...
DEFAULT_RESULTS_DIR = BASE / "results" / "llama4_runs_FAERS"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "One-pass Llama-4 FAERS annotation using scripts/annotation_prompts.py:P2_TAG "
...
def main() -> None:
    ...
    console_print("")
    console_print("=== LLAMA-4 FAERS EVALUATION ===")
    console_print(
