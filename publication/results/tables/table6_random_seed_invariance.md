...
| :--- | :--- | :---: | :---: |
| FAERS (4-Fold LOO, N = 829) | Seed 42 | 0.5470 | 0.7402 |
| FAERS (4-Fold LOO, N = 829) | Seed 123 | 0.5524 | 0.7369 |
| FAERS (4-Fold LOO, N = 829) | Seed 456 | 0.5636 | 0.7523 |
| FAERS (4-Fold LOO, N = 829) | Seed 789 | 0.5571 | 0.7386 |
| FAERS (4-Fold LOO, N = 829) | Seed 1011 | 0.5620 | 0.7422 |
| **FAERS (4-Fold LOO, Pooled)** | **Mean ± SD (5 Seeds)** | **0.5564 ± 0.0069** | **0.7420 ± 0.0061** |
...
3. **Pooled Invariance:** The pooled summary represents the Mean $\pm$ SD across the 5 independent random initialization seeds, demonstrating minimal stochastic variation ($SD = 0.0069$ on FAERS, $SD = 0.0016$ on VAERS).
