...
const AnnotationPanel = (props: Props) => {
  ...
  return (
    <div className="annotation-panel flex flex-col h-full bg-transparent overflow-hidden font-sans">
      <div className="p-4 border-b border-slate-100 bg-white/50">
        <div className="relative group">
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-[11px] focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all placeholder:text-slate-300 shadow-sm"
          />
