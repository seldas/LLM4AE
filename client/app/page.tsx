      ...
      <aside className="w-64 bg-slate-900 flex flex-col z-20">
        <div className="p-6 border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-sm font-bold text-white tracking-widest uppercase">SCAT</h1>
            <span className="text-[9px] font-black bg-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded border border-blue-500/30 tracking-tighter">API</span>
          </div>
        </div>

        <div className="flex-1 overflow-y-auto py-4">
          <div className="px-6 mb-3 text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em]">Navigation</div>
          <nav className="px-3 space-y-0.5">
            <button
              className="w-full flex items-center gap-3 px-4 py-2.5 rounded text-[12px] font-medium transition-all bg-slate-800 text-white"
            >
              <span className="text-blue-400"><IconFolder /></span>
              <span className="truncate uppercase tracking-tight">Cases Inventory</span>
            </button>
          </nav>
        </div>
