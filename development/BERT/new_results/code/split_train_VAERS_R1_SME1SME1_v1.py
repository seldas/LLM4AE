...
# åŠ è½½åŽŸå§‹ .spacy æ–‡ä»¶
input_path = "train_VAERS_SME1_revision.spacy"
...
train_output_path = "train_VAERS_SME1_new_revision.spacy"
train_doc_bin.to_disk(train_output_path)

# å°†æµ‹è¯•é›†ä¿å­˜åˆ°æ–°çš„ .spacy æ–‡ä»¶ä¸­
test_doc_bin = DocBin(docs=test_docs)
test_output_path = "dev_train_VAERS_SME1_new_revision.spacy"
